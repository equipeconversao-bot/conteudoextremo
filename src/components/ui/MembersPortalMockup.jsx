import { Play, CheckCircle2, Lock, MonitorPlay, FileText, ChevronRight } from 'lucide-react'
      ...
      <div className="flex flex-1 flex-col bg-surface">
        ...
        <div className="flex h-full flex-col gap-6 overflow-hidden p-6 lg:flex-row">
          <div className="flex flex-1 flex-col gap-4">
            <div className="group relative flex aspect-video w-full flex-col justify-end overflow-hidden rounded-lg bg-neutral-900 shadow-inner">
              <div className="absolute inset-0 bg-gradient-to-br from-neutral-900 via-neutral-900 to-emerald/20 opacity-80" />
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative flex items-center justify-center">
                  ...
                  <div className="relative flex h-16 w-16 cursor-pointer items-center justify-center rounded-full bg-emerald text-white shadow-soft transition-transform duration-200 hover:scale-105">
                    <Play size={24} className="ml-1 fill-current" strokeWidth={0} />
                  </div>
                </div>
              </div>

              <div className="relative z-10 flex h-12 w-full items-center gap-4 bg-gradient-to-t from-black/80 to-transparent px-4">
                <Play size={16} className="fill-current text-white" strokeWidth={0} />
                <div className="relative h-1.5 flex-1 cursor-pointer overflow-hidden rounded-full bg-white/20">
                  <div className="relative h-full w-[45%] overflow-hidden rounded-full bg-emerald">
                    <div className="absolute inset-0 h-full w-full -translate-x-full animate-[shimmer_2s_infinite] bg-gradient-to-r from-transparent via-white/40 to-transparent" />
                  </div>
                </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-start gap-3 rounded-md bg-ink/5 p-2">
                <div className="mt-0.5 flex shrink-0 text-emerald">
                  <Play size={16} className="fill-current" strokeWidth={0} />
                </div>
