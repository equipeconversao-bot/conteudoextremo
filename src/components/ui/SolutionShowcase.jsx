import { ArrowRight, Brain, Zap, Target, ShieldCheck, Image as ImageIcon } from 'lucide-react'
    ...
    >
      ...
      <div className="flex w-full flex-1 items-center justify-center">
        <div className="relative flex aspect-video w-full items-center justify-center overflow-hidden rounded-xl border border-hairline bg-elevated">
          ...
          />
          <div className="relative flex h-16 w-16 items-center justify-center rounded-2xl border border-hairline bg-surface stroke-brand-gradient shadow-sm">
