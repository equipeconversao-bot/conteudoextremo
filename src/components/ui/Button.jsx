...
const variants = {
  ...
  secondary:
    'ds-btn-secondary bg-gradient-to-b from-white to-neutral-50 text-neutral-900 ring-1 ring-inset ring-black/5 shadow-[inset_0_1px_1px_rgba(255,255,255,1),inset_0_-2px_4px_rgba(0,0,0,0.02),0_8px_20px_-4px_rgba(0,0,0,0.12)] hover:-translate-y-0.5 transform-gpu hover:shadow-[inset_0_1px_1px_rgba(255,255,255,1),inset_0_-2px_4px_rgba(0,0,0,0.03),0_12px_24px_-4px_rgba(0,0,0,0.16)] hover:!ring-white dark:bg-none dark:bg-transparent dark:text-ink dark:shadow-none dark:ring-hairline-strong dark:ring-2 dark:hover:translate-y-0 dark:hover:shadow-none dark:hover:!ring-white',
